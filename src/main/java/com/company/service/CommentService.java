...
public class CommentService {
    ...
    public CommentDTO create(CommentCreateDTO dto) {
        ...
        HomeEntity home = homeService.get(dto.getHomeId());
    ...
    public CommentDTO getDTO(CommentEntity commentEntity) {
        ...
        commentDTO.setHomeDTO(homeService.getDTO(commentEntity.getHome()));
        commentDTO.setProfile(profileService.getProfile(commentEntity.getProfile().getId()));
